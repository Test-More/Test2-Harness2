...
Test2::Harness2::TestFile - Abstraction of a test file and its meta-data.

=head1 DESCRIPTION

When Test2::Harness2 finds test files to run each one gets an instance of this
...
If you write a custom L<Test2::Harness2::Finder> or use some
L<Test2::Harness2::Plugin> callbacks you may have to use, or even construct
...
=head1 SYNOPSIS
    ...
    my $tf = Test2::Harness2::TestFile->new(file => "path/to/file.t");
