package Test2::Harness2::Runner::Resource::SharedJobSlots;
use strict;
use warnings;
...
use YAML::Tiny;
use Test2::Harness2::Runner::Resource::SharedJobSlots::State;
use Test2::Harness2::Runner::Resource::SharedJobSlots::Config;
...
sub init {
    ...
    $self->{+STATE} = Test2::Harness2::Runner::Resource::SharedJobSlots::State->new(
        dir        => $dir,
        name       => $name,
        runner_id  => $runner_id,
...
Test2::Harness2::Runner::Resource::SharedJobSlots - limit the job count (-j) per machine
...
instance of C<Test2::Harness2::Runner::Resource::SharedJobSlots::State>.
...
C<Test2::Harness2::Runner::Resource::SharedJobSlots::State> which implement the
