package Test2::Harness2::Runner::DepTracer;
use strict;
use warnings;
...
Test2::Harness2::Runner::DepTracer - Tool for tracing module dependencies as
they are loaded.

=head1 DESCRIPTION

This tool is used by Test2::Harness2 to build a graph of dependancies which can
...
=head1 SYNOPSIS
    ...
    my $dt = Test2::Harness2::Runner::DepTracer->new();
    ...
    my $dt_reference = Test2::Harness2::Runner::DepTracer->ACTIVE;
...
=item $dt_or_undef = Test2::Harness2::Runner::DepTracer->ACTIVE();
