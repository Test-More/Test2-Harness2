package Test2::Harness2::Runner::Preload;
use strict;
use warnings;
...
sub import {
    ...
    $exports{watch} = sub {
        ...
        if ($INC{'Test2/Harness2/Runner/DepTracer.pm'}) {
            if (my $active = Test2::Harness2::Runner::DepTracer->ACTIVE) {
...
Test2::Harness2::Runner::Preload - DSL for building complex stage-based preload
tools.
...
method being present is how Test2::Harness2 differentiates between a regular
