package Test2::Harness2::Settings::Prefix;
use strict;
use warnings;
...
sub build {
    ...
    require(Test2::Harness2::Util::mod2file($class));
...
Test2::Harness2::Settings::Prefix - Abstraction of a settings category, aka prefix.
