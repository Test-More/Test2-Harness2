...
use Test2::Harness2::Util::HashBase qw/pretty/;
...
Subclass of L<Test2::Harness2::Util::File> which automatically handles
...
See the base class L<Test2::Harness2::Util::File> for methods.
