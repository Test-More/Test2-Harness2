...
sub send_event {
    ...
    unless ($SEND_EVENT) {
        ...
        local $@;
        $SEND_EVENT = eval { Test2::Harness2::Collector::Child->send_event } or Carp::confess("Cannot send an event from here: $@");
        $SEND_EVENT_PID = $$;
    }
...
sub shell_call {
    ...
    require Test2::Harness2::IPC::Util;
    my $pid = Test2::Harness2::IPC::Util::start_collected_process(
