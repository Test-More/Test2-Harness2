package Test2::Harness2::Auditor::TimeTracker;
use strict;
use warnings;
...
Test2::Harness2::Auditor::TimeTracker - Module that tracks timing data while an
...
=head1 SYNOPSIS
    ...
    my $tracker = Test2::Harness2::Auditor::TimeTracker->new();
