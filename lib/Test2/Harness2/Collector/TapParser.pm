package Test2::Harness2::Collector::TapParser;
use strict;
use warnings;
...
Test2::Harness2::Collector::TapParser - Produce EventFacets from a line of TAP.
...
=head1 SYNOPSIS
    ...
    use Test2::Harness2::Collector::TapParser qw/parse_tap_line/;
