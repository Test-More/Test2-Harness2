package Test2::Harness2::Renderer::Formatter;
use strict;
use warnings;
...
BEGIN { require Test2::Harness2::Renderer; our @ISA = ('Test2::Harness2::Renderer') }
...
Test2::Harness2::Renderer::Formatter - Renderer that uses any Test2::Formatter
for rendering.
