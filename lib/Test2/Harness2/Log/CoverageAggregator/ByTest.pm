package Test2::Harness2::Log::CoverageAggregator::ByTest;
use strict;
use warnings;
...
use parent 'Test2::Harness2::Log::CoverageAggregator';
use Test2::Harness2::Util::HashBase qw/<in_progress <completed/;
...
Test2::Harness2::Log::CoverageAggregator::ByTest - Aggregate coverage by test
