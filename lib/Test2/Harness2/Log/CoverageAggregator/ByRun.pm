package Test2::Harness2::Log::CoverageAggregator::ByRun;
use strict;
use warnings;
...
use Test2::Harness2::Util::HashBase qw/<coverage <finalized/;
...
Test2::Harness2::Log::CoverageAggregator::ByRun - Aggregate test data by run
