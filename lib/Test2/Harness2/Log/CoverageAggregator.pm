package Test2::Harness2::Log::CoverageAggregator;
use strict;
use warnings;
...
use Test2::Harness2::Util::HashBase qw/<touched <job_map +can_touch +can_start_test +can_stop_test +can_record_coverage <file +io <encode/;
...
Test2::Harness2::Log::CoverageAggregator - Module for aggregating coverage data
...
=head1 SYNOPSIS
    ...
    use Test2::Harness2::Log::CoverageAggregator;

    my $agg = Test2::Harness2::Log::CoverageAggregator->new();
