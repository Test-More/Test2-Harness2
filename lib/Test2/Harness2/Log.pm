...
Test2::Harness2::Log - Documentation about the L<Test2::Harness2> log file.

=head1 DESCRIPTION

L<Test2::Harness2> aka L<App::Yath2> produces a rich/complete log when asked to
do so. This module documents the log format.

=head1 COMPRESSION

Test2::Harness2 can output log files uncompressed, compressed in gzip, or
compressed in bzip2.

=head1 FORMAT

The log file is in jsonl format. Each line of the log can be indepentantly
parsed as json. Each line represents a single event Test2::Harness2 processed
during a run. These events will be in the original order Test2::Harness2
...
B<Please note:> Older versions of Test2::Harness2 produced less complete events,
...
In addition to the original facets of the event, Test2::Harness2 may inject the
...
A hash representation of an L<Test2::Harness2::Runner::Job> object.
...
L<Test2::Harness2::Log::TimeTracker> Object.
...
A hash representation of an L<Test2::Harness2::Run> object.
