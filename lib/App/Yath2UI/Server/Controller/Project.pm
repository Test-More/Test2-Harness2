package App::Yath2UI::Server::Controller::Project;
use strict;
use warnings;
...
use App::Yath2UI::Schema::Util qw/format_duration parse_duration is_invalid_subtest_name/;
...
App::Yath2UI::Server::Controller::Project - Controller for fetching project data.
