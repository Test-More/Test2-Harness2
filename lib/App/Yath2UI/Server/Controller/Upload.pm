package App::Yath2UI::Server::Controller::Upload;
use strict;
use warnings;
...
use App::Yath2UI::Schema::Queries();
...
sub handle {
    ...
    my $content = $tx->render(
        'upload.tx',
        {
            ...
            user     => $user,
            projects => App::Yath2UI::Schema::Queries->new(config => $self->{+SCHEMA_CONFIG})->projects,
        }
    );
...
App::Yath2UI::Server::Controller::Upload - Controller for uploading logs
