package App::Yath2UI::Server::Controller::Sweeper;
use strict;
use warnings;

our $VERSION = '2.000011';

use App::Yath2UI::Schema::Sweeper;
...
sub handle {
    ...
    my $sweeper = App::Yath2UI::Schema::Sweeper->new(
        interval => $interval,
...
App::Yath2UI::Server::Controller::Sweeper - Controller for triggering database sweeps
