package App::Yath2UI::Server::Controller::Resources;
use strict;
use warnings;
...
use App::Yath2UI::Schema::Util qw/find_job/;
...
App::Yath2UI::Server::Controller::Resources - controller for fetching resource data.
