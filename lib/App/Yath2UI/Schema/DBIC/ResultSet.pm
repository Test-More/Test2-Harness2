package App::Yath2UI::Schema::DBIC::ResultSet;
use strict;
use warnings;
...
use App::Yath2UI::Schema::DBIC qw/format_uuid_for_db/;
...
App::Yath2UI::Schema::DBIC::ResultSet - Common resultset class for unified DBIC schema.
