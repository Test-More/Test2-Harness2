package App::Yath2UI::Schema::DBIC::Result::User;
use utf8;
use strict;
use warnings;
...
__PACKAGE__->has_many(
    "api_keys" => "App::Yath2UI::Schema::DBIC::Result::ApiKey",
    { "foreign.user_id" => "self.user_id" },
    { cascade_copy => 0, cascade_delete => 1 },
);

__PACKAGE__->has_many(
    "emails" => "App::Yath2UI::Schema::DBIC::Result::Email",
    { "foreign.user_id" => "self.user_id" },
    { cascade_copy => 0, cascade_delete => 1 },
);

__PACKAGE__->has_many(
    "permissions" => "App::Yath2UI::Schema::DBIC::Result::Permission",
    { "foreign.user_id" => "self.user_id" },
    { cascade_copy => 0, cascade_delete => 1 },
);

__PACKAGE__->might_have(
    "primary_email" => "App::Yath2UI::Schema::DBIC::Result::PrimaryEmail",
    { "foreign.user_id" => "self.user_id" },
    { cascade_copy => 0, cascade_delete => 1 },
);

__PACKAGE__->has_many(
    "projects" => "App::Yath2UI::Schema::DBIC::Result::Project",
...
__PACKAGE__->has_many(
    "runs" => "App::Yath2UI::Schema::DBIC::Result::Run",
    { "foreign.user_id" => "self.user_id" },
    { cascade_copy => 0, cascade_delete => 1 },
);

__PACKAGE__->has_many(
    "session_hosts" => "App::Yath2UI::Schema::DBIC::Result::SessionHost",
    { "foreign.user_id" => "self.user_id" },
    { cascade_copy => 0, cascade_delete => 1 },
);
...
App::Yath2UI::Schema::DBIC::Result::User - DBIC Result class for the User table.
