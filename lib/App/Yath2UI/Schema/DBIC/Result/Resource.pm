package App::Yath2UI::Schema::DBIC::Result::Resource;
use utf8;
use strict;
use warnings;
...
__PACKAGE__->belongs_to(
    "host" => "App::Yath2UI::Schema::DBIC::Result::Host",
    { host_id => "host_id" },
    {
        is_deferrable => 0,
        join_type     => "LEFT",
...
__PACKAGE__->belongs_to(
    "resource_type" => "App::Yath2UI::Schema::DBIC::Result::ResourceType",
...
App::Yath2UI::Schema::DBIC::Result::Resource - DBIC Result class for the Resource table.
