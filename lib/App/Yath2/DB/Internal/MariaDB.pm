package App::Yath2::DB::Internal::MariaDB;
use strict;
use warnings;
...
# App::Yath2::DB::Internal; this class only fills in flavor-specific bits:
#
...
App::Yath2::DB::Internal::MariaDB - MariaDB-backed Log reader / writer.

=head1 SYNOPSIS

    my $log = App::Yath2::DB::Internal::MariaDB->new(dsn => 'dbi:MariaDB:dbname=yath');
    # OR
    my $log = App::Yath2::DB::Internal::MariaDB->new(dbh => $dbh, uuid => $u);
...
Subclasses L<App::Yath2::DB::Internal> and provides only the MariaDB-
