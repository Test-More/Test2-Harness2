...
App::Yath2::Renderer::JUnit - Captures Test2::Harness2 results and emits a junit xml file.
...
C<App::Yath2::Renderer::JUnit> provides JUnit output formatting sufficient
...
Timing information is included in the JUnit XML since this is native to C<Test2::Harness2>
...
This method is called by Test2::Harness2 when all runs are complete. It takes what has
