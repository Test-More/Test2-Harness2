...
App::Yath2::Plugin - Base class for yath plugins
...
L<Test2::Harness2::Plugin> holds the methods specific to L<Test2::Harness2> which
is the backend.

=head1 SYNOPSIS

    package App::Yath2::Plugin::MyPlugin;
...
B<Note:> See L<Test2::Harness2::Plugin> for additional method you can implement/override
