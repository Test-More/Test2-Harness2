...
sub command_info_hash {
    ...
    my %commands;
    my $command_libs = { %{find_libraries('App::Yath2::Command::*')}, %{find_libraries('App::Yath2::Command::*::*')}};
...
sub command_help {
    ...
    require App::Yath2;
    my $cmd_class = "App::Yath2::Command::$command";
    require(mod2file($cmd_class));

    my $app = App::Yath2->new(command => $cmd_class, settings => $self->settings);
