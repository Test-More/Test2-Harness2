package App::Yath2::Command::collector;
use strict;
use warnings;
...
sub run {
    ...
    my $run = Test2::Harness2::Run->new(%{decode_json(<STDIN>)});
...
App::Yath2::Command::collector - For internal use only
...
=head1 USAGE
    ...
    $ yath [YATH OPTIONS] collector [OPTIONS]
