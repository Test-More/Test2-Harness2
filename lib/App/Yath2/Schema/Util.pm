...
sub schema_config_from_settings {
    ...
    my $config_class = delete $params{config_class} // 'App::Yath2::Schema::Config';
...

{
    no strict 'refs';
    no warnings 'once';
    *{$_} = *{"App::Yath2::Schema::$_"} for qw/is_mysql is_postgresql is_sqlite is_percona is_mariadb/;
}

sub format_uuid_for_db  { App::Yath2::Schema->format_uuid_for_db(@_) }
sub format_uuid_for_app { App::Yath2::Schema->format_uuid_for_app(@_) }
