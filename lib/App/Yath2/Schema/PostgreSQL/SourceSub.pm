use utf8;
package App::Yath2::Schema::PostgreSQL::SourceSub;
...
App::Yath2::Schema::PostgreSQL::SourceSub - Autogenerated result class for SourceSub in PostgreSQL.

=head1 SEE ALSO

L<App::Yath2::Schema::Overlay::SourceSub> - Where methods that are not
