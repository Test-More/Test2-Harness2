package App::Yath2::Schema::Config;
use strict;
use warnings;
...
sub schema {
...

    {
        ...
        unless ($App::Yath2::Schema::LOADED) {
            ...
            require(mod2file("App::Yath2::Schema::$schema"));
        }
    }

    require App::Yath2::Schema;

    return $self->{+_SCHEMA} = App::Yath2::Schema->connect(
        $self->dbi_dsn,
        $self->dbi_user,
        $self->dbi_pass,
...
App::Yath2::Schema::Config - Schema configuration
