package App::Yath2::Schema::Overlay::Event;
...
use App::Yath2::Schema::ImportModes();
...
sub in_mode {
    my $self = shift;
    return App::Yath2::Schema::ImportModes::event_in_mode(event => $self, @_);
}
...
App::Yath2::Schema::Overlay::Event - Overlay for Event result class.
