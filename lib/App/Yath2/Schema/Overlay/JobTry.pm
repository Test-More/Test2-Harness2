package App::Yath2::Schema::Overlay::JobTry;
...
use App::Yath2::Schema::ImportModes qw/record_all_events mode_check/;
...
App::Yath2::Schema::Overlay::JobTry - Overlay for JobTry result class.
