package App::Yath2::Schema::DateTimeFormat;
use strict;
use warnings;
...
sub DTF {
    ...
    if ($App::Yath2::Schema::LOADED =~ m/postgresql/i) {
        require DateTime::Format::Pg;
        return $DTF = 'DateTime::Format::Pg';
    }

    if ($App::Yath2::Schema::LOADED =~ m/(mysql|mariadb|percona)/i) {
        require DateTime::Format::MySQL;
        return $DTF = 'DateTime::Format::MySQL';
    }

    if ($App::Yath2::Schema::LOADED =~ m/sqlite/i) {
...
App::Yath2::Schema::DateTimeFormat - FIXME
