package App::Yath2::Log::DB::MariaDB;
use strict;
use warnings;
...
App::Yath2::Log::DB::MariaDB - MariaDB-backed Log reader / writer.

=head1 SYNOPSIS

    my $log = App::Yath2::Log::DB::MariaDB->new(dsn => 'dbi:MariaDB:dbname=yath');
    # OR
    my $log = App::Yath2::Log::DB::MariaDB->new(dbh => $dbh, uuid => $u);
