package App::Yath2::Log::DB::Postgres;
use strict;
use warnings;
...
App::Yath2::Log::DB::Postgres - PostgreSQL-backed Log reader / writer.

=head1 SYNOPSIS

    my $log = App::Yath2::Log::DB::Postgres->new(dsn => 'dbi:Pg:dbname=yath');
    # OR
    my $log = App::Yath2::Log::DB::Postgres->new(dbh => $dbh, uuid => $u);
