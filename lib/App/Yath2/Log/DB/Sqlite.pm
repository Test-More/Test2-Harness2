package App::Yath2::Log::DB::Sqlite;
use strict;
use warnings;
...
App::Yath2::Log::DB::Sqlite - SQLite-backed Log reader / writer.

=head1 SYNOPSIS

    my $log = App::Yath2::Log->new(file => '/tmp/run.yath');
    # OR
    my $log = App::Yath2::Log::DB::Sqlite->new(file => '/tmp/run.yath');
    # OR
    my $log = App::Yath2::Log::DB::Sqlite->new(dbh => $dbh, uuid => $u);
