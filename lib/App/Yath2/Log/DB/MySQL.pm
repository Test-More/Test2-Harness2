package App::Yath2::Log::DB::MySQL;
use strict;
use warnings;
...
App::Yath2::Log::DB::MySQL - MySQL/Percona-backed Log reader / writer.

=head1 SYNOPSIS

    my $log = App::Yath2::Log::DB::MySQL->new(
        dsn => 'dbi:MariaDB:database=yath;host=db.local',
    );
    # OR
    my $log = App::Yath2::Log::DB::MySQL->new(dbh => $dbh, uuid => $u);
