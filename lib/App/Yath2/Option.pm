...
sub cli_docs {
    ...
    push @out => App::Yath2::Util::fit_to_width($width, ",  ", \@forms);

    my $desc = App::Yath2::Util::fit_to_width($width, " ", $self->{+DESCRIPTION});
    $desc =~ s/^/  /gm;
    push @out => $desc;
...
App::Yath2::Option - Representation of a yath option.
...
use App::Yath2::Options which provides sugar, and helps make sure options get to
the right place.
...
structure, an instance of L<Test2::Harness2::Settings>. The structure is
...
The L<App::Yath2::Options> instance this options belongs to. This is mainly
...
=item $class->new(from_command => 'App::Yath2::Command::COMMAND')

=item $cmd_class = $opt->from_command()

If your option was defined for a specific command this will be set. You do not
normally set this yourself, the tools in L<App::Yath2::Options> usually handle
that for you.

=item $class->new(from_plugin => 'App::Yath2::Plugin::PLUGIN')
...
to inject additional L<App::Yath2::Option> instances into the
L<App::Yath2::Options> instance.
...
The L<App::Yath2::Options> instance.
...
if the option is applicable given the L<App::Yath2::Options> instance.
