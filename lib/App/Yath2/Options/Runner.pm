...
option_group {group => 'runner', category => "Runner Options"} => sub {
    ...
    option resources => (
        ...
        name           => 'resource',
        short          => 'R',
        long_examples  => [' Port', ' CPU', ' CPU=70', ' Memory=20%', ' UnixLimits', ' UnixLimits=nofile=10%', ' Disk=/tmp:25%', ' +Test2::Harness2::Runner::Resource::Port'],
        short_examples => [' Port', ' CPU', ' CPU=70', ' Memory=20%', ' UnixLimits', ' Disk=/tmp:25%'],
        description    => "Use a resource module to assign resource assignments to individual tests. Some resources accept an inline argument after '=' (e.g. CPU=70, Memory=512mb, UnixLimits=nofile=10%, Disk=/tmp:25%).",
