package App::Yath2::Server::Controller::Resources;
use strict;
use warnings;
...
use App::Yath2::Schema::Util qw/find_job/;
use App::Yath2::Schema::DateTimeFormat qw/DTF/;
...
App::Yath2::Server::Controller::Resources - controller for fetching resource data.
