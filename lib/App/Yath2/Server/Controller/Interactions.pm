package App::Yath2::Server::Controller::Interactions;
use strict;
use warnings;
...
use App::Yath2::Schema::Util qw/find_job is_mysql/;
...
App::Yath2::Server::Controller::Interactions - Check for interactions between tests
