...
| 24 | Transition-driven test completion (§5.4): decide pass/fail/retry/bail from collector transitions + connection EOF; collector exit health-only; bidirectional collector conns + runner→collector terminate message; fd hygiene. Spans Test2-Collector. | ⬜ | #32 (fd hygiene, gates), #27 |
