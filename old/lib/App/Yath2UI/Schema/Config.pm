package App::Yath2UI::Schema::Config;
use strict;
use warnings;
...
sub schema {
...

    {
        ...
        unless ($App::Yath2UI::Schema::DBIC::LOADED) {
            ...
            require(mod2file("App::Yath2UI::Schema::DBIC::$schema"));
        }
    }

    require App::Yath2UI::Schema::DBIC;

    return $self->{+_SCHEMA} = App::Yath2UI::Schema::DBIC->connect(
        $self->dbi_dsn,
        $self->dbi_user,
        $self->dbi_pass,
...
App::Yath2UI::Schema::Config - Schema configuration
