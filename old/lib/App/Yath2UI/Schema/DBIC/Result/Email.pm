package App::Yath2UI::Schema::DBIC::Result::Email;
use utf8;
use strict;
use warnings;
...
__PACKAGE__->might_have(
    "email_verification_code" => "App::Yath2UI::Schema::DBIC::Result::EmailVerificationCode",
...
App::Yath2UI::Schema::DBIC::Result::Email - DBIC Result class for the Email table.
