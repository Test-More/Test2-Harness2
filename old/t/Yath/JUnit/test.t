...

{
    ...
    yath(
        ...
        test        => sub {
            ...
            like(
                $out->{output},
                qr{\Q( PASSED )\E.*\Qt/Yath/JUnit/test-ok/pass-1.tx\E},
                "t/Yath/JUnit/test-ok/pass-1.tx"
            );
            like(
                $out->{output},
                qr{\Q( PASSED )\E.*\Qt/Yath/JUnit/test-ok/pass-2.tx\E},
                "t/Yath/JUnit/test-ok/pass-2.tx"
            );
    ...
    like(
        $junit => hash {
            field testsuite => hash {
                field 'Yath_JUnit_test-ok_pass-1_tx' => hash {
                    field errors   => 0;
                    field failures => 0;
                    field id       => D();
                    ...
                    field 'testcase' => hash {
                        field '0001 - pass' => hash {
                            field classname => 'Yath_JUnit_test-ok_pass-1_tx';
                            field time      => D();
                            end;
                        };
                ...
                field 'Yath_JUnit_test-ok_pass-2_tx' => hash {
                    field errors   => 0;
                    field failures => 0;
                    field id       => D();
                    ...
                    field 'testcase' => hash {
                        field '0001 - pass' => hash {
                            field classname => 'Yath_JUnit_test-ok_pass-2_tx';
                            field time      => D();
                            end;
                        };
                        field 'Tear down.' => hash {
...

{
    ...
    yath(
        ...
        test        => sub {
            ...
            like(
                $out->{output},
                qr{\Q( PASSED )\E.*\Qt/Yath/JUnit/test-no-numbers/pass-1.tx\E},
                "t/Yath/JUnit/test-no-numbers/pass-1.tx"
            );
    ...
    like(
        $junit => hash {
            field testsuite => hash {
                ...
                field failures => 0;
                field id       => D();
                field name     => 'Yath_JUnit_test-no-numbers_pass-1_tx';
                ...
                field 'testcase' => hash {
                    field 'pass' => hash {
                        field classname => 'Yath_JUnit_test-no-numbers_pass-1_tx';
                        field time      => D();
                        end;
                    };
                    field 'Tear down.' => hash {
...

{
    ...
    yath(
        ...
        test        => sub {
            ...
            like(
                $out->{output},
                qr{\Q( FAILED )\E.*\Qt/Yath/JUnit/test-fail/fail.tx\E},
                "t/Yath/JUnit/test-fail/fail.tx"
            );
    ...
    like(
        $junit => hash {
            field testsuite => hash {
                ...
                field failures => 1;
                field id       => D();
                field name     => 'Yath_JUnit_test-fail_fail_tx';
                ...
                field 'testcase' => hash {
                    field '0001 - pass' => hash {
                        field classname => 'Yath_JUnit_test-fail_fail_tx';
                        field time      => D();
                        end;
                    };
...

{
    ...
    yath(
        ...
        test        => sub {
            ...
            like(
                $out->{output},
                qr{\Q( FAILED )\E.*\Qt/Yath/JUnit/test-plan/plan.tx\E},
                "t/Yath/JUnit/test-plan/plan.tx"
            );
    ...
    like(
        $junit => hash {
            field testsuite => hash {
                ...
                field failures => 0;
                field id       => D();
                field name     => 'Yath_JUnit_test-plan_plan_tx';
                ...
                field 'testcase' => hash {
                    field '0001 - pass' => hash {
                        field classname => 'Yath_JUnit_test-plan_plan_tx';
                        field time      => D();
                        end;
                    };
...

{
    ...
    yath(
        ...
        test        => sub {
            ...
            like(
                $out->{output},
                qr{\Q( FAILED )\E.*\Qt/Yath/JUnit/test-die/die.tx\E},
                "t/Yath/JUnit/test-die/die.tx"
            );
    ...
    like(
        $junit => hash {
            field testsuite => hash {
                ...
                field failures => 0;
                field id       => D();
                field name     => 'Yath_JUnit_test-die_die_tx';
                ...
                field 'testcase' => hash {
                    field '0001 - pass' => hash {
                        field classname => 'Yath_JUnit_test-die_die_tx';
                        field time      => D();
                        end;
                    };
                    field '0002 - another success' => hash {
...

{
    ...
    yath(
        ...
        test        => sub {
            ...
            like(
                $out->{output},
                qr{\Q(TO RETRY)\E.*\Qt/Yath/JUnit/test-retry/retry.tx\E},
                "TO RETRY t/Yath/JUnit/test-retry/retry.tx"
            );
            like(
                $out->{output},
                qr{\Q( PASSED )\E.*\Qt/Yath/JUnit/test-retry/retry.tx\E},
                "PASSED t/Yath/JUnit/test-retry/retry.tx"
            );
    ...
    like(
        $junit => hash {
            field testsuite => hash {
                ...
                field failures => 0;
                field id       => D();
                field name     => 'Yath_JUnit_test-retry_retry_tx';
                ...
                field 'testcase' => hash {
                    field '0001 - Minimal result' => hash {
                        field classname => 'Yath_JUnit_test-retry_retry_tx';
                        field time      => D();
                        end;
                    };
                    field 'Tear down.' => hash {
