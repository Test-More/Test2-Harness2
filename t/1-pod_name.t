...
sub wanted {
    ...
    # Auto-generated DBIx::Class result classes (DBIx::Class::Schema::Loader
    # output, marked "DO NOT MODIFY"; regenerated by author_tools/regen_schema.pl)
    # do not follow the package-on-line-1 / =head1 NAME conventions.
    return if $file =~ m{lib/App/Yath2/Schema/(?:SQLite|MySQL|MariaDB|Percona|PostgreSQL)/};
