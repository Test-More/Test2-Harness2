...
use Test2::V0;
plan skip_all => "TODO: preload (-P) modules not implemented; daemon lifecycle not wired";
__END__
...
yath(
    ...
    test    => sub {
        ...
        like($out->{output}, qr{Can't locate Test2/Harness2/Preload/Does/Not/Exist\.pm}, "Reported the error");
    },
);
