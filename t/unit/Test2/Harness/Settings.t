use Test2::V0 -target => 'Test2::Harness2::Settings';
...
isa_ok($one->foo, ['Test2::Harness2::Settings::Prefix'], "Defined the prefix");
...
like(
    ...
    qr/All prefixes must contain instances of Test2::Harness2::Settings::Prefix/,
