...
# Mirrors t/AI/unit/Log/Directory/iterator.t but archives the
# directory and drives the iterator off the tar.zidx backend.
...
# events() list-context drains.
{
    ...
    # Second call on a drained sealed log: a single trailing undef.
