...
my $qdb = get_db({ driver => 'MariaDB' });
{
    ...
    $admin->do('CREATE DATABASE IF NOT EXISTS yath_log_test_specrep');
    $admin->disconnect;
}
...
# Schema: legacy spec/state dropped; new ones present.
