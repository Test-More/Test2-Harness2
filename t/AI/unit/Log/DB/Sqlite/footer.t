...

{
    ...
    my $sq = App::Yath2::Log::DB::Sqlite->new(file => $path);
    ...
    # Trailer-extracted meta must match the archives row.
    ...
    # SQLite still readable: raw DBI can open and query.
    require DBI;
    ...
    # File size must equal body_size + meta_size + footer.
    my $disk = -s $path;
...

{
    ...
    # And the instance is not flagged sealed; further inserts allowed.
