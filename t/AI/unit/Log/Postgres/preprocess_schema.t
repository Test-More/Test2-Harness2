...
# Unit-style test for App::Yath2::Log::Postgres::_preprocess_schema_sql.
...
sub with_compression {
    my ($algo, $code) = @_;
    my $db = bless {}, 'App::Yath2::Log::Postgres';
    no warnings 'redefine';
    local *App::Yath2::Log::Postgres::_server_compression = sub { $algo };
    $code->($db);
}
