...
# Ticket TODO-45: the old DBIx::Class DB/web layer (App::Yath2::Schema::Importer ->
...
# are loaded below.
BEGIN { plan skip_all => "App::Yath2::Schema::Importer/RunProcessor moved to reference/old_db (ticket TODO-45); DB layer is being rewritten" }
