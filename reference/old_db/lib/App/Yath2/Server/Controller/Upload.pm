package App::Yath2::Server::Controller::Upload;
use strict;
use warnings;
...
sub handle {
    ...
    my $content = $tx->render(
        'upload.tx',
        {
            ...
            user     => $user,
            projects => App::Yath2::Schema::Queries->new(config => $self->{+SCHEMA_CONFIG})->projects,
        }
    );
...
App::Yath2::Server::Controller::Upload - Controller for uploading logs
