...
use App::Yath2::Schema::Util qw/schema_config_from_settings format_duration/;
...
sub run {
    ...
    my $cb = App::Yath2::Schema::RunProcessor->process_lines($settings, project => $project, print_links => 1);
