...
Test2::Harness2::Preload::Stage - Data structure representing a preload stage definition.

=head1 DESCRIPTION

This is an implementation detail. You are not intended to directly use/modify
instances of this class. See L<Test2::Harness2::Preload> for
