package Test2::Harness2::Runner::Preloading;
use strict;
use warnings;
...
use Test2::Harness2::Util qw/parse_exit mod2file/;
use Test2::Harness2::Util::JSON qw/encode_json/;
use Test2::Harness2::IPC::Util qw/pid_is_running/;

use Test2::Harness2::Preload();
use Test2::Harness2::TestSettings;
use Test2::Harness2::Runner::Preloading::Stage;

use parent 'Test2::Harness2::Runner';
...
sub start_base_stage {
    ...
    my $pid = Test2::Harness2::Runner::Preloading::Stage->launch(
        name            => 'BASE',
...
Test2::Harness2::Runner::Preloading - FIXME
