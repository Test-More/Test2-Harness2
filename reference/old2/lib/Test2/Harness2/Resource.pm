...
use Test2::Harness2::IPC::Util qw/start_collected_process ipc_connect set_procname/;
use Test2::Harness2::Util::JSON qw/decode_json_file encode_json_file/;
...
sub send_event {
    ...
    my $send = $self->{+_SEND_EVENT} //= Test2::Harness2::Collector::Child->send_event;
