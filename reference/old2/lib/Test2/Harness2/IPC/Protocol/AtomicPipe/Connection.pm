package Test2::Harness2::IPC::Protocol::AtomicPipe::Connection;
use strict;
use warnings;
...
use parent 'Test2::Harness2::IPC::Connection';
...
sub init {
    ...
    weaken($self->{+READER});
    $self->{+PROTOCOL} //= 'Test2::Harness2::IPC::Protocol::AtomicPipe';
...
sub send_request {
    ...
    my $req = Test2::Harness2::Instance::Request->new(
        request_id     => $id,
        api_call       => $api_call,
        args           => $args,
...
sub send_response {
    ...
    $res = Test2::Harness2::Instance::Response->new(%$req, response_id => $req->request_id)
        unless blessed($res) && $res->isa('Test2::Harness2::Instance::Response');
...
Test2::Harness2::IPC::Protocol::AtomicPipe::Connection - FIXME
