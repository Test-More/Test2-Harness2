package App::Yath2UI::Schema::DBIC::Result::JobTry;
use utf8;
use strict;
use warnings;
...
use App::Yath2UI::Schema::ImportModes qw/record_all_events mode_check/;
...
__PACKAGE__->has_many(
    "events" => "App::Yath2UI::Schema::DBIC::Result::Event",
    { "foreign.job_try_id" => "self.job_try_id" },
    { cascade_copy => 0, cascade_delete => 1 },
);

__PACKAGE__->belongs_to(
    "job" => "App::Yath2UI::Schema::DBIC::Result::Job",
    { job_id => "job_id" },
    { is_deferrable => 0, on_delete => "CASCADE", on_update => "NO ACTION" },
);

__PACKAGE__->has_many(
    "job_try_fields" => "App::Yath2UI::Schema::DBIC::Result::JobTryField",
    { "foreign.job_try_id" => "self.job_try_id" },
    { cascade_copy => 0, cascade_delete => 1 },
);
...
App::Yath2UI::Schema::DBIC::Result::JobTry - DBIC Result class for the JobTry table.
