package App::Yath2UI::Schema::DBIC::Result::Project;
use utf8;
use strict;
use warnings;
...
__PACKAGE__->belongs_to(
    "owner" => "App::Yath2UI::Schema::DBIC::Result::User",
    { user_id => "owner" },
    {
        is_deferrable => 0,
        join_type     => "LEFT",
...
App::Yath2UI::Schema::DBIC::Result::Project - DBIC Result class for the Project table.
