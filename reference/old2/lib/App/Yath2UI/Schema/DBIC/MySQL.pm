package App::Yath2UI::Schema::DBIC::MySQL;
use utf8;
use strict;
use warnings;
use Carp();
...
$App::Yath2UI::Schema::DBIC::LOADED = "MySQL";
...
App::Yath2UI::Schema::DBIC::MySQL - MySQL connection module for the unified DBIC schema.
