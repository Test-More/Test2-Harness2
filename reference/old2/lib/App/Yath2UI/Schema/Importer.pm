package App::Yath2UI::Schema::Importer;
use strict;
use warnings;
...
use Test2::Harness2::Util::HashBase qw/-config -worker_id/;
...
sub process_log {
    ...
    my $processor = App::Yath2UI::Schema::RunProcessor->new(
        run => $run,
        config => $self->{+CONFIG},
        buffer => 1,
    );
...
App::Yath2UI::Schema::Importer - Import a log
