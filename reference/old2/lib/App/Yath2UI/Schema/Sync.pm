package App::Yath2UI::Schema::Sync;
use strict;
use warnings;
...
App::Yath2UI::Schema::Sync - Module for dumping, loading, and syncing yath databases
...
=head1 SYNOPSIS
    ...
    use App::Yath2UI::Schema::Sync;

    my $source_dbh = ...;
    my $dest_dbh   = ...;

    my $sync = App::Yath2UI::Schema::Sync->new();
