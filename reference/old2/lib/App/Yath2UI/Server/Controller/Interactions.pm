package App::Yath2UI::Server::Controller::Interactions;
use strict;
use warnings;
...
use App::Yath2UI::Schema::Util qw/find_job is_mysql/;
...
App::Yath2UI::Server::Controller::Interactions - Check for interactions between tests
