package App::Yath2UI::Server::Controller::Stream;
use strict;
use warnings;
...
use App::Yath2UI::Schema::Util qw/find_job_and_try format_uuid_for_db/;
...
App::Yath2UI::Server::Controller::Stream - Controller for streaming data that is still being generated.
