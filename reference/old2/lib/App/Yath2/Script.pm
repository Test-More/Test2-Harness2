...
sub script { $App::Yath2::Script::SCRIPT }

$Test2::Harness2::Util::USING_ALT //= 0;
sub goto_alt_script {
    ...
    die "Recursion detected when using alternate $app_name script" if $Test2::Harness2::Util::USING_ALT++;
...
sub run {
    ...
    $App::Yath2::Script::SCRIPT //= $script;
    ...
    die "yath script ($App::Yath2::Script::SCRIPT) has a different version than App::Yath2 ($INC{'App/Yath.pm'})\n     Script: $script_version\n  App::Yath2: $app_version\n\n"
