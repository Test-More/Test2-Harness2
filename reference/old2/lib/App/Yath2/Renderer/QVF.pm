package App::Yath2::Renderer::QVF;
use strict;
use warnings;

our $VERSION = '2.000011';

use parent 'App::Yath2::Renderer::Default';
...
App::Yath2::Renderer::QVF - Yath renderer that is [Q]uiet but [V]erbose on
[F]ailure.

=head1 DESCRIPTION

This renderer is a subclass of L<App::Yath2::Renderer::Default>. This one will
