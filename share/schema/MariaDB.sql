...
-- PostgreSQL.sql; no generated columns here as there is no uuid_string mirror).
...
-- is_harness_out = job0 / harness internal log. passed = folded "any try passed"
-- (resolved); failed = resolved && !passed (spec §4/§4.1). NO should_retry column
-- (runtime-only, R17). No job_uuid_string mirror: native uuid is readable (§3b).
CREATE TABLE jobs (
