...
use Test2::Harness2::UI::Util qw/share_dir share_file/;
...
builder {
    ...
    mount '/' => sub {
        require Test2::Harness2::UI;
        require Test2::Harness2::UI::Config;
        ...
        Test2::Harness2::UI->new(config => $config)->to_app->(@_);
    }
}
